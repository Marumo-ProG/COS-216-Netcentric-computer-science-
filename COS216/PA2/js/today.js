// fetch the data from the api when the page loads
...
function LoadData(){
    ...
    xhttp.open("GET","https://api.thenewsapi.com/v1/news/top?api_token=6PrT5g1tOc5vhk594pZxFwJkHMHXOZhviMc3MK7z&locale=us&limit=5",true);
    xhttp.send();
